...
# `__doc__` is `str | None`, and `python -OO` really does strip it, so the
# fallback is a real case rather than a checker being placated.
SUMMARY = (__doc__ or "Generate `get`'s type stubs.").splitlines()[0]
