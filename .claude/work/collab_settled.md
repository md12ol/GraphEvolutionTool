# Settled collaboration items — archive

Items that are closed. Split out of `collab.md` on 2026-08-13 at the joint meeting (`collab.md`
#59), because the `## Open` / `## Settled` headings inside one file had stopped describing where
items physically sat. **This file is union-merged, exactly like `collab.md`** — the formatting rules
in `.claude/CLAUDE.md` apply here unchanged: unique heading, unique closing stamp, append rather
than edit.

File order is preserved from the original split and is **not** numeric order; it never was. Nothing
was reworded on the way across.
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Confirmed closed; moved to the archive. The `/done` body's contradiction was corrected before the meeting and nothing further is owed.

*(Settled inside #40 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Confirmed closed; moved to the archive. The outcome was ratified 2026-08-10, the route explicitly not.

*(Settled inside #41 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Two further pairs get their own sweep issue: the genomes, and `config.rs`/`py_config.rs` scoped to **differ and say why** rather than de-duplicate, because `traps.md` records that mirror cannot be collapsed. GitHub #56 stays unassigned. Reasoning in the meeting file.

*(Settled inside #43 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Confirmed closed. The row agreed 2026-08-11 and never written is folded into #52(a)'s single `CLAUDE.md` row, so the rule covers `CLAUDE.md` edits and skill bodies alike and does not need agreeing a third time.

*(Settled inside #44 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Confirmed closed — PR #59 is merged and GitHub #56's sweep is otherwise intact.

*(Settled inside #46 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Confirmed closed — the `dispatch.rs` placement stands, and both stale lines were corrected in PR #63.

*(Settled inside #47 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** The shipped example becomes a **working demonstration**: `infection_rate` rises to a value with a real selection gradient, commented to say it trades realism for a visible one, and `examples/config_builder.py`'s `the_shipped_example()` mirrors it exactly. The coupling between the two is filed as an issue.

*(Settled inside #48 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Ratified, all four points, now binding: `pip install` is v1 scope, wheels for three platforms, the demo layer stays in `examples/`, distribution is PyPI. §8 names maturin and `abi3-py38`. Reasoning in `decisions.md` 2026-08-13 20:17.

*(Settled inside #49 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Confirmed closed — PR #63 landed `reject_stray_fitness_keys` and §8's contradiction clause is fully implemented, so nothing is outstanding.

*(Settled inside #45 · 2026-08-13 — Michael & James.)*

### 63. FYI: auto-delete-on-merge is on, and it will not clean up your local merges
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Renumbered from the duplicate `### 48` per #59 — the earlier `config.example.toml` item keeps that number, this FYI takes the next free one. Confirmed closed and moved to the archive.

*(Settled inside #63 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Documentation pages describe **present behaviour only**; `status.html` becomes the single page naming unbuilt work, and the badges and `.plan-note` callouts go. The upkeep moves out of the shipping PR into the batched sweep, which pre-agrees #53's direction.

*(Settled inside #50 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** All five carry. Items 1, 2, 3 and 5 ratified as written; item 4 keeps the code and fixes the wording, `Swap`'s third check being named as a deliberate anti-clustering guard. Items 3 and 5 get their own issues, plus a third for the uncovered `Swap` branch. Reasoning in `decisions.md` 2026-08-13 20:18.

*(Settled inside #51 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** (a) carries: a practice-binding `CLAUDE.md` or skill-body change goes direct to `main` **with a mandatory** `collab.md` ACKNOWLEDGE item; "prefer a PR" is withdrawn. (b) carries in both `/load` and `/save`, oldest unanswered first, with **no age threshold**. Reasoning in `decisions.md` 2026-08-13 20:15.

*(Settled inside #52 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Confirmed at the meeting with James's rider intact — a sweep reads every queue file, not only its own. An applied entry is tagged `edited — please verify` by the sweeper and deleted only by the queue's owner. The sweep is a standing alternating task, one per meeting cycle.

*(Settled inside #53 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Acknowledged, no change. The direct push was correct, and #52(a) has now made it the rule rather than a departure from it. Tier (8) placement stands. The #68/#56 overlap on `generational.rs` and `steady_state.rs` doc comments is recorded in both issue bodies.

*(Settled inside #54 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Acknowledged and accepted as written — that path, that step, nothing else. Under #62 the exception will name the second repository rather than `main`; the exception itself is unchanged.

*(Settled inside #55 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** The function list is struck from §5.1's boundary line: the diagram locates the flip, §8 enumerates the surface. Reasoning in `decisions.md` 2026-08-13 20:19.

*(Settled inside #56 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** De-duplicate — `HANDOFF.md`'s planned table is deleted and replaced by a pointer to `status.html`, which #50 made the sole roadmap index. Routed through #53's queue rather than edited directly.

*(Settled inside #57 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** The acknowledgement is discharged. Caveat 1 is **mooted by #62**, not answered — the script it concerns is deleted by that migration. Caveat 2 carries: `/load` will say whether an absent owner directory means no live task or an incomplete setup.

*(Settled inside #58 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** The file splits: `collab.md` keeps open items, `collab_settled.md` takes the archive, and the 80 cross-file references measured in the room (72 `decisions.md`, 5 `traps.md`, 3 `issues.md`) are retargeted where the item moved. The duplicate `### 48` is renumbered to **#63**. `/save` and `/load` will print the highest item number so nobody guesses again.

*(Settled inside #59 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Acknowledged; the decide-versus-execute split stands, having been run end to end for this meeting. The camelCase skill names are renamed to match the repo's others, riding #62's migration.

*(Settled inside #60 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** `set_base_graph` **rejects loudly** on every case: an out-of-range endpoint and a self-loop each raise `PyValueError` naming the edge. `Graph::set_edge` is unchanged, and the asymmetry is recorded. Reasoning in `decisions.md` 2026-08-13 20:16.

*(Settled inside #61 · 2026-08-13 — Michael & James.)*
...
**Settled at the joint meeting of 2026-08-13 — Michael & James.** Recorded here for completeness — agreed jointly in the room and already stamped above; the reasoning lives in `decisions.md` 2026-08-13 14:03 and the migration is filed as a single checklist issue.

*(Settled inside #62 · 2026-08-13 — Michael & James.)*
